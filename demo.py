...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--server-port", type=int, default=8860)
...
def build_predictor(config_path: str, checkpoint_path: str):
    ...
    def run(image: Image.Image | None, question: str, topk: int):
        ...
        return [[answer, round(probability, 4)] for answer, probability in results]
...
def main() -> None:
    ...
    with gr.Blocks(title="VQA Demo") as demo:
        ...
        output = gr.Dataframe(headers=["Answer", "Probability"], label="Predictions")
